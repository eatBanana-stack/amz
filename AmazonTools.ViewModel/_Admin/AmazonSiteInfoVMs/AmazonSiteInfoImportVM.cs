...
namespace AmazonTools.ViewModel._Admin.AmazonSiteInfoVMs
{
    public partial class AmazonSiteInfoTemplateVM : BaseTemplateVM
    {
        ...
        public ExcelPropety SiteName_Excel = ExcelPropety.CreateProperty<AmazonSiteInfo>(x => x.SiteName);
        ...
        public ExcelPropety AmazonState_Excel = ExcelPropety.CreateProperty<AmazonSiteInfo>(x => x.AmazonState);
