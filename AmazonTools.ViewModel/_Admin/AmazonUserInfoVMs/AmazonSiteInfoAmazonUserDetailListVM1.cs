...
{
    public partial class AmazonSiteInfoAmazonUserDetailListVM1 : BasePagedListVM<AmazonSiteInfo, AmazonSiteInfoDetailSearcher1>
    {
        ...
        protected override List<GridAction> InitGridAction()
        {
            ...
            {
                this.MakeStandardAction("AmazonSiteInfo", GridActionStandardTypesEnum.AddRow, "新建","", dialogWidth: 800),
                this.MakeStandardAction("AmazonSiteInfo", GridActionStandardTypesEnum.RemoveRow, "删除","", dialogWidth: 800),
            };
        }
    ...
    public partial class AmazonSiteInfoDetailSearcher1 : BaseSearcher
    {
