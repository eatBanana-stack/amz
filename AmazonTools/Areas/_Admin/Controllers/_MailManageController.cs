...
namespace AmazonTools._Admin.Controllers
{
    ...
    public partial class MailManageController : BaseApiController
    {
        ...
        {
            var vm = Wtm.CreateVM<MailManageVM>(id);
            return Ok(vm);
        }

        [ActionDescription("Sys.Create")]
        [HttpPost("[action]")]
        public async Task<IActionResult> Create(MailManageVM vm)
        {
        ...
        [HttpPut("[action]")]
        public async Task<IActionResult> Edit(MailManageVM vm)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState.GetErrorJson());
        ...
        public ActionResult BatchEdit(MailManageBatchVM vm)
        {
        ...
        {
            var vm = Wtm.CreateVM<MailManageImportVM>();
        ...
        [HttpPost("Import")]
        public ActionResult Import(MailManageImportVM vm)
        {
